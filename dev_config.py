...
SMART_TRADER_PATHS = {
    ...
    'models': {
        ...
        'market_stock': SMART_TRADER_ROOT / "apps" / "common" / "models" / "market_stock.py",
...
def copy_smart_trader_reference(category: str, component: str, target_service: str, target_name: str = None):
...
def migrate_market_models():
    ...
    try:
        copy_smart_trader_reference('models', 'market', 'data_service', 'market_reference.py')
        copy_smart_trader_reference('models', 'market_stock', 'data_service', 'market_stock_reference.py')
...
def migrate_portfolio_models():
    ...
    try:
        copy_smart_trader_reference('models', 'portfolio', 'portfolio_service', 'portfolio_reference.py')
        copy_smart_trader_reference('models', 'wishlist', 'portfolio_service', 'wishlist_reference.py')
...
def migrate_strategy_models():
    ...
    try:
        copy_smart_trader_reference('models', 'strategy', 'strategy_service', 'strategy_reference.py')
        copy_smart_trader_reference('models', 'screening', 'strategy_service', 'screening_reference.py')
