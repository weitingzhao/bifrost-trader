...
class StrategyCategory(models.Model):
    ...
    strategy = models.ForeignKey(
        Strategy, on_delete=models.DO_NOTHING, null=True, blank=True
    )
    # Data
    strategy_category = models.CharField(
        max_length=50, choices=StrategyCategoryChoices.choices, null=True, blank=True
    )
