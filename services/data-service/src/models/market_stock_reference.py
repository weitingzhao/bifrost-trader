...
class MarketStockDividend(models.Model):
    ...
    five_year_avg_dividend_yield = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    trailing_annual_dividend_rate = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    trailing_annual_dividend_yield = models.DecimalField(
        max_digits=20, decimal_places=9, null=True, blank=True
    )
...
class MarketStockPrice(models.Model):
    ...
    regular_market_open = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    regular_market_day_low = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    regular_market_day_high = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
...
class MarketStockValuation(models.Model):
    ...
    trailing_peg_ratio = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    ...
    forward_eps = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
...
class MarketStockTarget(models.Model):
    ...
    target_high_price = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    target_low_price = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    target_mean_price = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    target_median_price = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    recommendation_mean = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
...
class MarketStockPerformance(models.Model):
    ...
    two_hundred_day_average = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
    earnings_quarterly_growth = models.DecimalField(
        max_digits=15, decimal_places=7, null=True, blank=True
    )
...
class MarketStockShare(models.Model):
    ...
    shares_percent_shares_out = models.DecimalField(
        max_digits=20, decimal_places=9, null=True, blank=True
    )
