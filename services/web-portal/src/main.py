...
from .api import dashboard, portfolio, trading, websocket
...
async def dashboard_page(request: Request):
    ...
    try:
        ...
        return HTMLResponse(
            content="<h1>Bifrost Trader Dashboard</h1><p>Service is running on port 8006</p>"
        )
...
async def trading_page(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse(
            "pages/trading/live.html",
            {"request": request, "trading_data": trading_data},
        )
    except Exception as e:
        print(f"Trading page error: {e}")
        return templates.TemplateResponse(
            "pages/trading/live.html", {"request": request, "trading_data": None}
        )
...
async def backtesting_page(request: Request):
    """Backtesting page."""
    return templates.TemplateResponse(
        "pages/trading/backtesting.html", {"request": request}
    )
...
async def portfolio_page(request: Request):
    ...
    return templates.TemplateResponse(
        "pages/portfolio/overview.html", {"request": request}
    )
...
async def analytics_page(request: Request):
    """Analytics page."""
    return templates.TemplateResponse(
        "pages/analytics/market.html", {"request": request}
    )
...
async def research_page(request: Request):
    """Research page."""
    return templates.TemplateResponse(
        "pages/research/screening.html", {"request": request}
    )
...
async def settings_page(request: Request):
    """Settings page."""
    return templates.TemplateResponse(
        "pages/settings/account.html", {"request": request}
    )
...
async def health_check():
    """Health check endpoint."""
    return {"status": "healthy", "service": "web-portal", "version": "1.0.0"}
